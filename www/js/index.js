...
window._ = require("./../lib/underscore/underscore.js");

window.$ = require("./../lib/jquery/dist/jquery.js");

window.$.deparam = require("./../lib/jquery-deparam/jquery-deparam.js");
...
require("./../lib/angular-touch/angular-touch.js");

require("./../lib/ng-file-upload/angular-file-upload.js");

require("./../lib/tagDirective/index.js");

require("./../lib/angular-translate/angular-translate.js");

require("./../lib/angular-translate-loader-static-files/angular-translate-loader-static-files.js");
...
require("./../lib/ionic-press-again-to-exit/index.js");



},{"./../lib/angular-activerecord/src/angular-activerecord.js":17,"./../lib/angular-http-auth/src/http-auth-interceptor.js":18,"./../lib/angular-touch/angular-touch.js":19,"./../lib/angular-translate-loader-static-files/angular-translate-loader-static-files.js":20,"./../lib/angular-translate/angular-translate.js":21,"./../lib/ionic-press-again-to-exit/index.js":22,"./../lib/jquery-deparam/jquery-deparam.js":23,"./../lib/jquery/dist/jquery.js":24,"./../lib/ng-file-upload/angular-file-upload.js":25,"./../lib/ngCordova/dist/ng-cordova.js":26,"./../lib/tagDirective/index.js":28,"./../lib/underscore/underscore.js":31,"./app.coffee":11,"./controller.coffee":12,"./env.coffee":13,"./locale.coffee":14,"./model.coffee":15,"./platform.coffee":16,"promise":2}],2:[function(require,module,exports){
'use strict';
...
module.run(function($rootScope, platform, $ionicPlatform, $location, $http, authService, $cordovaToast, $ionicPressAgainToExit) {
  var data, fulfill;
  ...
  $ionicPressAgainToExit(function() {
    return $cordovaToast.show('Press again to exit', 'short', 'center');
  });
  ...
  $rootScope.$on('event:auth-forbidden', function() {
    return platform.auth().then(fulfill, alert);
  });
...
module.config(function($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider.state('app.timeslotCreate', {
    ...
    resolve: {
      cliModel: 'model',
      model: function(cliModel) {
        var ret;
        return ret = new cliModel.Timeslot();
      }
    }
  });
  ...
  $stateProvider.state('app.locationCreate', {
    ...
    resolve: {
      ...
      model: function(cliModel) {
        var ret;
        return ret = new cliModel.Location();
      }
    }
  });
  ...
  $stateProvider.state('app.resourceCreate', {
    ...
    resolve: {
      ...
      model: function(cliModel) {
        var ret;
        return ret = new cliModel.Resource();
      },
      locationList: function(cliModel) {
        var ret;
        ret = new cliModel.LocationList();
        return ret.$fetch();
      }
  ...
  $stateProvider.state('app.reservation', {
    ...
    resolve: {
      cliModel: 'model',
      translate: '$translate',
      timeslotList: function(cliModel) {
        var ret;
        ret = new cliModel.TimeslotList();
        return ret.$fetch();
      },
      resourceList: function(cliModel) {
        var ret;
        ret = new cliModel.ResourceList();
        return ret.$fetch();
      },
      user: function(cliModel) {
        return cliModel.User.me();
      },
      inputDate: function($stateParams) {
        var ret;
      ...
      datepickerTitleLabel: function(translate) {
        return translate('Select Date').then(function(translation) {
          return translation;
        });
      }
    }
  ...
  $stateProvider.state('app.reservationByResource', {
    ...
    resolve: {
      ...
      resource: function(cliModel, $stateParams) {
        var ret;
        if ($stateParams.resource) {
          ret = new cliModel.Resource({
            id: $stateParams.resource
          });
          return ret.$fetch();
        }
      },
  ...
  $stateProvider.state('app.reservationCreate', {
    ...
    resolve: {
      cliModel: 'model',
      translate: '$translate',
      resource: function($stateParams, cliModel) {
        var ret;
        ret = new cliModel.Resource();
        if ($stateParams.resource) {
          ret = new cliModel.Resource({
      ...
      time: function($stateParams, cliModel) {
        var ret;
        ret = new cliModel.Timeslot();
        if ($stateParams.time) {
          ret = new cliModel.Timeslot({
      ...
      model: function(cliModel, resource, date, time) {
        return new cliModel.Reservation({
          resource: resource,
          date: date,
          time: time
        });
  ...
  return $urlRouterProvider.otherwise('/timeslot');
});



},{}],12:[function(require,module,exports){
var LocationCtrl, LocationListCtrl, MenuCtrl, MyReservationListCtrl, Promise, ReservationByResourceListCtrl, ReservationCtrl, ReservationListCtrl, ResourceCtrl, ResourceListCtrl, TimeslotCtrl, TimeslotListCtrl, config, env;
...
TimeslotCtrl = function($scope, model, $location) {
  return _.extend($scope, {
    model: model,
    save: function() {
      return $scope.model.$save().then((function(_this) {
        return function() {
          return $location.url("/timeslot");
        };
      })(this));
    }
  });
...
TimeslotListCtrl = function($scope, collection, $location) {
  return _.extend($scope, {
    collection: collection,
    create: function() {
      return $location.url("/timeslot/create");
    },
    read: function(id) {
      return $location.url("/timeslot/read/" + id);
    },
    edit: function(id) {
      return $location.url("/timeslot/edit/" + id);
    },
    "delete": function(obj) {
      return obj.$destroy();
    },
...
LocationCtrl = function($scope, model, $location) {
  return _.extend($scope, {
    model: model,
    save: function() {
      return $scope.model.$save().then((function(_this) {
...
LocationListCtrl = function($scope, collection, $location) {
  return _.extend($scope, {
    collection: collection,
    create: function() {
      return $location.url("/location/create");
    },
    read: function(id) {
      return $location.url("/location/read/" + id);
    },
    edit: function(id) {
      return $location.url("/location/edit/" + id);
    },
    "delete": function(obj) {
      return obj.$destroy();
    },
...
ResourceCtrl = function($scope, cliModel, model, locationList, $location) {
  var modelEvents;
  _.extend($scope, {
    model: model,
    save: function() {
  ...
  _.each(modelEvents, (function(_this) {
    return function(modelField, event) {
      return $scope.$on(event, function(event, item) {
        return $scope.model[modelEvents[event.name]] = item;
      });
    };
  })(this));
  $scope.selectLocationList = [
    new cliModel.Location({
      name: '-- Please select location --',
      label: '-- Please select location --'
    })
  ];
  _.each(locationList.models, (function(_this) {
    return function(location) {
      location.label = location.name;
      return $scope.selectLocationList.push(location);
    };
  })(this));
  return cliModel.User.me().then((function(_this) {
    return function(user) {
      return $scope.me = user;
    };
  })(this));
};

ResourceListCtrl = function($scope, collection, $location) {
  return _.extend($scope, {
    collection: collection,
    create: function() {
      return $location.url("/resource/create");
    },
    read: function(id) {
      return $location.url("/resource/read/" + id);
    },
    edit: function(id) {
      return $location.url("/resource/edit/" + id);
    },
    "delete": function(obj) {
      return obj.$destroy();
    },
...
ReservationCtrl = function($scope, cliModel, model, resourceList, timeslotList, $filter, $location, source, $ionicPopup, datepickerTitleLabel) {
  _.extend($scope, {
    model: model,
    resourceList: resourceList,
    timeslotList: timeslotList,
    save: function() {
      var backToMainPage, saveRecords, selectedTimeslots;
      saveRecords = function() {
        return new Promise(function(fulfill, reject) {
          _.each(selectedTimeslots, function(timeslot) {
            $scope.model = _.omit($scope.model, 'id');
            $scope.model.time = timeslot;
            return $scope.model.$save()["catch"](alert);
          });
          return fulfill();
        });
      };
      backToMainPage = function() {
        if (source === 'date') {
          ...
          return $location.search("date", $scope.datepickerObject.inputDate.getTime());
        } else {
          $location.url("/reservationByResource");
          return $location.search("resource", $scope.model.resource);
        }
      };
      selectedTimeslots = _.where(timeslotList.models, {
        checked: true
      });
      return saveRecords().then(function() {
    ...
    datepickerObject: {
      ...
      callback: function(val) {
        return $scope.datePickerCallback(val);
      }
    },
    datePickerCallback: function(val) {
      ...
      if (val) {
        ...
        return $scope.getAvailableTimeslot();
      }
    },
    getAvailableTimeslot: function() {
      var ref, reservationList;
      reservationList = new cliModel.ReservationList;
      return reservationList.$fetch({
        params: {
          date: $scope.model.date.getTime(),
          resource: (ref = $scope.model.resource) != null ? ref.id : void 0
        }
      }).then(function() {
        return $scope.$apply(function() {
          return _.each(timeslotList.models, (function(_this) {
            return function(obj) {
              obj.date = $scope.model.date.getTime();
              _this.reservation = _.findWhere(reservationList.models, {
                time: "" + obj.id
              });
              if (_this.reservation) {
                obj.disabled = true;
                obj.reservedBy = '[ ' + _this.reservation.createdBy.username + ' ]';
  ...
  $scope.$on('Select Resource', function(event, item) {
...
MyReservationListCtrl = function($scope, collection, $location, $ionicModal, $ionicListDelegate, $state) {
  _.extend($scope, {
    collection: collection,
    isToday: function(d) {
      var iDate, today;
    ...
    create: function() {
      return $location.url("/reservation/create");
    },
    "delete": function(obj) {
      obj.$destroy();
    ...
    edit: function(obj) {
      $scope.model = obj;
      return $ionicModal.fromTemplateUrl("templates/reservation/edit.html", {
        scope: $scope
      }).then(function(modal) {
        _.extend($scope, {
          modal: modal,
    ...
    grouping: function() {
      ...
      return _.map($scope.grouped, function(value, key) {
        return $scope.grouped[key] = _.groupBy(value, function(obj) {
          return obj.time.name;
        });
      });
    },
    modalViewResource: function(resource) {
      $scope.model = resource;
      return $ionicModal.fromTemplateUrl("templates/resource/modal.html", {
        scope: $scope
      }).then(function(modal) {
        _.extend($scope, {
          modal: modal,
...
ReservationListCtrl = function($scope, cliModel, resourceList, timeslotList, inputDate, $filter, $location, $ionicModal, user, datepickerTitleLabel) {
  _.extend($scope, {
    user: user,
    resourceList: resourceList,
    timeslotList: timeslotList,
    ...
    getAvailableTimeslot: function() {
      return _.each($scope.resourceList.models, (function(_this) {
        return function(resource) {
          var reservationList;
          reservationList = new cliModel.ReservationList;
          return reservationList.$fetch({
            params: {
              date: $scope.datepickerObject.inputDate.getTime(),
              resource: resource.id
            }
          }).then(function() {
            return $scope.$apply(function() {
              return _.each(resource.timeslot.models, (function(_this) {
                return function(obj) {
                  ...
                  if (_this.reservation) {
                    obj.disabled = true;
                    return obj.reservedBy = _this.reservation.createdBy;
                  } else {
                    obj.disabled = false;
                    return obj.reservedBy = '';
                  }
                };
              })(this));
            });
    ...
    modalViewUser: function(user) {
      $scope.model = user;
      return $ionicModal.fromTemplateUrl("templates/user/modal.html", {
        scope: $scope
      }).then(function(modal) {
        _.extend($scope, {
          modal: modal,
  ...
  _.each($scope.resourceList.models, (function(_this) {
    return function(resource) {
      return resource.timeslot = angular.copy(timeslotList);
    };
  })(this));
...
ReservationByResourceListCtrl = function($scope, cliModel, resourceList, timeslotList, $filter, $location, $ionicModal, resource, user) {
  _.extend($scope, {
    user: user,
    resource: resource,
    resourceList: resourceList,
    timeslotList: timeslotList,
    getAvailableTimeslot: function() {
      return _.each($scope.dateList, (function(_this) {
        return function(dateObj) {
          ...
          return reservationList.$fetch({
            ...
            return $scope.$apply(function() {
              return _.each(dateObj.timeslot.models, (function(_this) {
                return function(obj) {
                  _this.reservation = _.findWhere(reservationList.models, {
                    time: "" + obj.id
                  });
    ...
    create: function(resource, date, time) {
      ...
      $location.search("date", date);
      $location.search("time", time);
      return $location.search("source", "resource");
    },
    getNewList: function() {
      $scope.dateList = [];
    ...
    getList: function() {
      return new Promise(function(fulfill, reject) {
        ...
        while (currDate < $scope.endDate) {
          ...
          $scope.dateList.push({
            date: d.getTime(),
            isWeekEnd: $scope.isWeekEnd(d),
            timeslot: angular.copy(timeslotList)
          });
    ...
    loadMore: function() {
      return $scope.getList($scope.endDate).then(function() {
        return $scope.$broadcast('scroll.infiniteScrollComplete');
      })["catch"](alert);
    },
    modalViewResource: function() {
...
},{"./env.coffee":13,"promise":2}],13:[function(require,module,exports){
module.exports = {
  isMobile: function() {
  ...
  oauth2: function() {
    return {
      ...
      opts: {
        ...
        client_id: this.isNative() ? 'reservationDEVAuth' : 'reservationDEVAuth'
      }
    };
  }
};
...
model = function(ActiveRecord, $rootScope, $upload, platform) {
  var Collection, Location, LocationList, Model, MyReservationList, PageableCollection, Reservation, ReservationList, Resource, ResourceList, Timeslot, TimeslotList, User;
  ...
  Timeslot = (function(superClass) {
    extend(Timeslot, superClass);

    function Timeslot() {
      return Timeslot.__super__.constructor.apply(this, arguments);
    }

    Timeslot.prototype.$idAttribute = 'id';

    Timeslot.prototype.$urlRoot = (env.apiUrl()) + "/api/timeslots";

    return Timeslot;

  })(Model);
  TimeslotList = (function(superClass) {
    extend(TimeslotList, superClass);

    function TimeslotList() {
      return TimeslotList.__super__.constructor.apply(this, arguments);
    }

    TimeslotList.prototype.$idAttribute = 'id';

    TimeslotList.prototype.$urlRoot = (env.apiUrl()) + "/api/timeslots";

    TimeslotList.prototype.$parse = function(res, opts) {
      _.each(res.results, (function(_this) {
        return function(value, key) {
          return res.results[key] = new Timeslot(res.results[key]);
        };
      })(this));
      return res;
    };
  ...
  Location = (function(superClass) {
    ...
    Location.prototype.$idAttribute = 'id';

    Location.prototype.$urlRoot = (env.apiUrl()) + "/api/locations";

    return Location;

  })(Model);
  LocationList = (function(superClass) {
    extend(LocationList, superClass);

    function LocationList() {
      return LocationList.__super__.constructor.apply(this, arguments);
    }

    LocationList.prototype.$idAttribute = 'id';

    LocationList.prototype.$urlRoot = (env.apiUrl()) + "/api/locations";

    LocationList.prototype.$parse = function(res, opts) {
      _.each(res.results, (function(_this) {
        return function(value, key) {
          return res.results[key] = new Location(res.results[key]);
        };
      })(this));
      return res;
    };
  ...
  Resource = (function(superClass) {
    ...
    Resource.prototype.$idAttribute = 'id';

    Resource.prototype.$urlRoot = (env.apiUrl()) + "/api/resources";

    return Resource;

  })(Model);
  ResourceList = (function(superClass) {
    ...
    ResourceList.prototype.$idAttribute = 'id';

    ResourceList.prototype.$urlRoot = (env.apiUrl()) + "/api/resources";

    ResourceList.prototype.$parse = function(res, opts) {
      _.each(res.results, (function(_this) {
        return function(value, key) {
          return res.results[key] = new Resource(res.results[key]);
        };
      })(this));
      return res;
    };
  ...
  Reservation = (function(superClass) {
    ...
    Reservation.prototype.$idAttribute = 'id';

    Reservation.prototype.$urlRoot = (env.apiUrl()) + "/api/reservations";

    return Reservation;

  })(Model);
  ReservationList = (function(superClass) {
    extend(ReservationList, superClass);

    function ReservationList() {
      return ReservationList.__super__.constructor.apply(this, arguments);
    }

    ReservationList.prototype.$idAttribute = 'id';

    ReservationList.prototype.$urlRoot = (env.apiUrl()) + "/api/reservations";

    ReservationList.prototype.$parse = function(res, opts) {
      _.each(res.results, (function(_this) {
        return function(value, key) {
          return res.results[key] = new Reservation(res.results[key]);
        };
      })(this));
      return res;
    };

    ReservationList.prototype.$fetch = function(opts) {
      if (opts == null) {
        opts = {};
      }
      opts.params = opts.params || {};
      opts.params.limit = opts.params.limit || 500;
      return ReservationList.__super__.$fetch.call(this, opts);
    };

    return ReservationList;

  })(PageableCollection);
  MyReservationList = (function(superClass) {
    extend(MyReservationList, superClass);

    function MyReservationList() {
      return MyReservationList.__super__.constructor.apply(this, arguments);
    }

    MyReservationList.prototype.$urlRoot = (env.apiUrl()) + "/api/reservations/me";

    MyReservationList.prototype.$fetch = function(opts) {
      if (opts == null) {
        opts = {};
      }
      opts.params = opts.params || {};
      opts.params.limit = 10;
      return MyReservationList.__super__.$fetch.call(this, opts);
    };
...
},{"./env.coffee":13}],16:[function(require,module,exports){
...
},{"./env.coffee":13,"promise":2}],17:[function(require,module,exports){
/*!
...
},{"./../jquery/dist/jquery.js":24}],24:[function(require,module,exports){
/*!
...
},{"./icon.coffee":27,"./select.coffee":29,"./tag.coffee":30}],29:[function(require,module,exports){
